...
### Question 10
*Create a new data frame built from the grades data set reshaped to a long format. The new data frame should keep the Id and the Group as the orignal variables. 
```{r}
